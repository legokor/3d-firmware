 ...
 */
  ...
  #define DEFAULT_CURRENT    1200
  #define DEFAULT_MICROTEPS  128
  ...
  #define INTERPOLATE      true
    ...
    #define X_MICROSTEPS     DEFAULT_MICROTEPS        // 0..256
    ...
    #define Y_MICROSTEPS     DEFAULT_MICROTEPS
    ...
    #define Z_MICROSTEPS     DEFAULT_MICROTEPS
