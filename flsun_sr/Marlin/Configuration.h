...
#define CUSTOM_MACHINE_NAME "LEGO3D SR"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 320.54             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.49, 0.0, -0.62 } // (mm) Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 151.70             // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.21, -0.15, -0.05 } // (mm) Get these values from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 3320 }
...
#define Z_PROBE_LOW_POINT          -25 // (mm) Farthest distance below the trigger-point to go before stopping
